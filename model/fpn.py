...
class FPN(nn.Module):
    ...
    def forward(self, x):
        ...
        p4 = self.toplayer1(self._upsample_add(p5, self.latlayer2(c4)))
        p3 = self.toplayer2(self._upsample_add(p4, self.latlayer3(c3)))
        return p3, p4, p5, p6, p7


def FPN50():
    return FPN(Bottleneck, num_blocks=[3, 4, 6, 3])


def FPN101():
    return FPN(Bottleneck, num_blocks=[3, 4, 23, 3])
